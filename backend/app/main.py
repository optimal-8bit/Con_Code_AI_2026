...
from app.api.symptom_summary_routes import router as symptom_summary_router
...
app.include_router(symptom_summary_router, prefix="/api/v1", tags=["Symptom Summary"])
