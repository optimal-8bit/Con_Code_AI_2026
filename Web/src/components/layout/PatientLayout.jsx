...
export default function PatientLayout({ children }) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden text-white pb-12 px-4 sm:px-6 lg:px-8" style={{ paddingTop: isScrolled ? '140px' : '200px' }} data-patient-theme="true">
      ...
      {/* Unified Sticky Header - Single Container */}
      <div className="fixed top-0 left-0 w-full z-50 transition-all duration-300">
        <div className="bg-black/30 backdrop-blur-xl border-b border-white/20 shadow-2xl">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between py-5">
              ...
              <Button 
                variant="ghost" 
                className="text-white hover:bg-white/20 whitespace-nowrap rounded-full flex-shrink-0" 
            ...
            {/* AI Features Row - Integrated within same container */}
            <div 
              className={`border-t border-white/10 transition-all duration-300 ease-out ${
                isScrolled 
                  ? 'max-h-0 opacity-0 overflow-hidden' 
                  : 'max-h-20 opacity-100 py-4'
              }`}
            >
              <div className="flex items-center justify-center gap-4">
                <div className="flex items-center gap-2 text-purple-300 text-sm font-semibold whitespace-nowrap">
